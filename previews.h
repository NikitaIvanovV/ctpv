...
Preview b_previews[] = {
    ...
    PR("a",        NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("ace",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("alz",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("arc",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("arj",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("bz",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("bz2",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("cab",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("cpio",     NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("deb",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("gz",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("jar",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("lha",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("lrz",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("lz",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("lzh",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("lzma",     NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("lzo",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("rar",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("rpm",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("rz",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("t7z",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tZ",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.7z",   NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.Z",    NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.bz",   NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.bz2",  NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.gz",   NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.lz",   NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.lzo",  NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tar.xz",   NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tbz",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tbz2",     NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tgz",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tlz",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("txz",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tZ",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("tzo",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("war",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("xpi",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("xz",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("Z",        NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("zip",      NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),
    PR("7z",       NULL,            NULL,             bsdtar,                  PREV_ATTR_NONE),

    PR("a",        NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("ace",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("alz",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("arc",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("arj",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("bz",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("bz2",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("cab",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("cpio",     NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("deb",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("gz",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("jar",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("lha",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("lrz",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("lz",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("lzh",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("lzma",     NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("lzo",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("rar",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("rpm",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("rz",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("t7z",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tZ",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.7z",   NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.Z",    NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.bz",   NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.bz2",  NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.gz",   NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.lz",   NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.lzo",  NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tar.xz",   NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tbz",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tbz2",     NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tgz",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tlz",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("txz",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tZ",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("tzo",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("war",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("xpi",      NULL,            NULL,             7z,                      PREV_ATTR_NONE),
    PR("xz",       NULL,            NULL,             7z,                      PREV_ATTR_NONE),
